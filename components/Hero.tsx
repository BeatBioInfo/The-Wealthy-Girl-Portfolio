...
const Hero = () => {
  ...
  return (
    <div id="profile" className="relative min-h-screen flex flex-col justify-start items-center pt-44 md:pt-52">
        
        {/* Hero Specific decorative elements */}
        <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-comet-500/5 rounded-full blur-[100px] pointer-events-none animate-pulse-slow"></div>
                    ...
                    {[...Array(12)].map((_, i) => (
                        <div
                            ...
                            style={{
                                top: '50%',
                                left: '50%',
                                transform: `rotate(${i * 30}deg) translateY(-55%) translateX(160px)`, 
                                marginTop: '-3px',
                                marginLeft: '-3px',
                            }}
                        />
